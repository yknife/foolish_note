...
![img](雪花算法.assets/795b3d1fa01bbd15d8b7b85c2724bf42.png)
...
- 也就是说41位可以表示2 41 − 1 2^{41}-1241−1个毫秒的值，转化成单位年则是( 2 41 − 1 ) / ( 1000 ∗ 60 ∗ 60 ∗ 24 ∗ 365 ) = 69 (2^{41}-1)/ (1000 * 60 * 60 * 24 *365) = 69(241−1)/(1000∗60∗60∗24∗365)=69年。
